	...
	return (
		<div className={styles.main}>
			<div className={styles.cardMain}>
				...
				<a
					href="https://www.youtube.com/watch?v=KQfWRr-xDXQ&list=PL7atYSa5SSm6A_cBzp3Lqyw-aEOdQw6Wn"
				...
				<a
					href="https://www.youtube.com/watch?v=VguyeTH76C0"
					className={styles.largeCard}
					target="_blank"
					rel="noopener noreferrer"
				>
				...
				<a
					href="https://www.youtube.com/watch?v=2xS70Zn-jRk"
					className={styles.largeCard}
					target="_blank"
					rel="noopener noreferrer"
				>
				...
				<a
					href="https://www.youtube.com/watch?v=ZQjK-GlTjEQ"
					className={styles.largeCard}
					target="_blank"
					rel="noopener noreferrer"
				>
			...
			<div className={styles.cardMain}>
				...
				<a
					href="https://www.youtube.com/@OneMessageFoundation"
					className={styles.largeCard}
					target="_blank"
					rel="noopener noreferrer"
				>
				...
				<a
					href="https://www.youtube.com/@muftimenkofficial"
					className={styles.largeCard}
					target="_blank"
					rel="noopener noreferrer"
				>
				...
				<a
					href="https://www.youtube.com/@assimalhakeem"
					className={styles.largeCard}
					target="_blank"
					rel="noopener noreferrer"
				>
				...
				<a
					href="https://www.youtube.com/@HamzasDen"
					className={styles.largeCard}
					target="_blank"
					rel="noopener noreferrer"
				>
