		...
		<div className={styles.main}>
			...
			<div className={styles.grid}>
				<GuideNode
					...
					name={"Quran"}
					paragraph={"This website provides Quran in various different language."}
				/>
				<GuideNode
				...
				/>
				<GuideNode
					site={"https://islamqa.info/en"}
					name={"Questions"}
					paragraph={"If you have any questions, go ahead and ask away."}
				/>
				<GuideNode
					site={"https://seekersguidance.org/"}
					name={"Courses"}
					paragraph={"Free courses to guild you through your questions."}
				/>
				<GuideNode
					site={"https://topquranclasses.com/"}
					name={"Classes"}
					paragraph={"This site provides classes regarding Quran."}
				/>
				<GuideNode
				...
				<GuideNode
					...
					paragraph={"Feel free to contribute."}
				/>
			</div>
		</div>
	);
